...
import random
list1 = list(random.randint(1,5) for i in range(int(input('Введите количество кустов: '))))
print(list1)
max=0
for i in range(len(list1)-1):
    if list1[i-1] + list1[i] + list1[i+1] > max:
        max = list1[i-1] + list1[i] + list1[i+1]
a = list1[-2] + list1[-1] + list1[0]
if a>max:
    max = a
print(max)